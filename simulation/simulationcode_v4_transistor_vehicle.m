...
region_ul = [100, 560]; % [y, x] of upper left corner
region_lr = [900, 1360]; % [y, x] of lower right corner
...
% Custom functions above threshold function1
